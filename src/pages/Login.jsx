...
export default function Login() {
  ...
  const CheckEmail = (e) => {
    if (e.key === 'Enter') {
      ...
      console.log(ID);
      if (ValidationEmail(ID)) {
        console.log(loginOutLine);
        setLoginOutLine('rgba(0,0,0, 0.2)');
        // setOpac(0);
      } else if (!ValidationEmail(ID)) {
        setLoginOutLine('red');
        // setOpac(100);
      }
    }
  ...
  const LoginInput = styled.input`
    ...
    width: 20vw;
    min-width: 320px;
    outline: 1px solid ${loginOutLine};
  ...
  const PasswordInput = styled.input`
    ...
    width: 20vw;
    min-width: 320px;
    outline: 1px solid ${passwordOutLine};
    background-color: rgba(218, 218, 218, 0.2);
    padding: 10px;
    border-radius: 5px;
  `;
